...
import logging
import unittest
from app.http_handlers import remove_user_handler

class TestRemoveUserHandler(unittest.TestCase):
    '''unit tests for remove_user_handler'''
    ...
    def test_remove_user_handler_true(self):
